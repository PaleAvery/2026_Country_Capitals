...
def get_capitals():
    ...
    file = open("country_capitals.xlsx", "r")
...
def get_round_colours():
    ...
    all_country_list = get_capitals()

    round_countries = random.sample(all_country_list,4)
    print(round_countries)
...
class StartGame:
    ...
    as the gui like the buttons and the overlay
        ...
        self.looping = PhotoImage(file="looping.gif")
    ...
    def difficulty(self):
        ...
        if is_hard:
            ...
            self.Difficulty_button.config(text="Easy",
                            bg="blue",image = self.looping,width=100,height=100)
            is_hard = False
        else:
...
class easy_game:
    ...
    def new_round(self):
        ...
        self.round_colour_list = get_round_colours()
        ...
        self.target_label.config(text=f"Target Score: ",
                                 font=("Arial", "14", "bold"))
    ...
    def round_results(self, user_choice):
        ...
        correct_capital = self.correct_answer
