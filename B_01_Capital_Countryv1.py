...
class Play:
    """
    Interface for the Capital game
    """
    ...
    def __init__(self, how_many):
        ...
        # list to hold UI element specifics like text, size of text and more / font /background
        label_list = [
            ["Question {question_played} or {questions_wanted}",("Arial",14,"bold"), None,0],
            ["What is the capital of {capital}",("Arial",12),"#ffe234",1],
            ["Choose the answer from the options below",("Arial",9),"ffe213",2 ],
            ["You picked {} and was {}", ("Arial",13),"#D5EED4",4]
        ]
